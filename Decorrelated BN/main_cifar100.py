...
save_dir = 'mpa_cifar100'
model_name = net._get_name()
id = randint(0, 1000)
logdir = os.path.join(save_dir, model_name+'18'+'group1e-2taylor9', '{}-bs{}'.format(norm, BatchSize), str(id))
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        best_acc = acc
    print('Best Validation Accuracy {}'.format(100 - best_acc))
