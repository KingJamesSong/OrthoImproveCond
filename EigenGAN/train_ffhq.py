...
if __name__ == "__main__":
    ...
    my_list6 = ['blocks.5.projection.U']
    ...
    params6 = list(map(lambda x: x[1], list(filter(lambda kv: kv[0] in my_list6, generator.named_parameters()))))
    base_params = list(map(lambda x: x[1], list(filter(lambda kv: kv[0] not in (my_list1+my_list2+my_list3+my_list4+my_list5+my_list6), generator.named_parameters()))))
    # optimizers
    print(params1)
    print(params2)
    print(params3)
    ...
    g_optim = torch.optim.Adam(
        [{'params': params1},{'params': params2},{'params': params3},{'params': params4},{'params': params5},{'params': params6},{'params': base_params}],
        lr=args.lr,
        betas=(0.5, 0.99),
    )
