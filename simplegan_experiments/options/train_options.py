...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--reg_type', type=str, default='orojar', help='[orojar | hp | vp | nog] the type of Regularization is applied: OroJaR/ Hessian Penalty/ VP/ Nearest-Orthogonal Gradient')
